<script lang="ts">
	import ComposerInstructionDetails from './ComposerInstructionDetails.svelte';
</script>

<ComposerInstructionDetails title="How to use the melody editor">
