...
export default {
	'tw-b': {
		...
		title: 'Twinkle Twinkle Little Star for Bass',
		description:
			'A musical, playable way for bass students to practice Twinkle — phrase by phrase, by ear, and with real accompaniment. Free demo from The Sharpest Note.',
		gumroadUrl: 'https://sharpestnote.gumroad.com/l/twinkle-bass',
		pieces: [
			{
